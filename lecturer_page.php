  ...
  <header class="masthead bg-primary " style=" margin-top: -120px;">
    <div class="container-fluid">
      ...
      <div class="col-md-9" style="height: 400px;">
        <div class="card mt-3">
          <div class="card-header"><i class="fa fa-user"> </i> Lecturer Dashboard</div>
          <div class="card-body">
            <div class="row">
              ...
              <div class="card bg-info">
                <div class="card-header"></div>
                 <!--  <div class="card-body-icon">
                  ...
                  <div class="card-body fa fa-user text-white"> Attendance Report</div>
                  <div class="text-white"></div>
                  <a href="admin_page.php" class="text-white" style="text-decoration: none;">
                    <div class="card-footer">
                      <span class="">View Details</span>
              ...
              <div class="card bg-success">
                <div class="card-header"></div>
                 <!--  <div class="card-body-icon">
                  ...
                  <div class="card-body text-white fa fa-pen"> Register Student</div>
                  <div class="text-white"></div>
                  <a href="admin_page.php" class="text-white" style="text-decoration: none;">
                    <div class="card-footer">
                      <span class="">View Details</span>
