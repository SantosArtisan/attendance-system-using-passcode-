...
if($_SESSION['username']&&$password){
  ...
  $sql= mysqli_query($connection,"SELECT * FROM lecturer WHERE username='".$_SESSION['username']."'");
  ...
  <header class="masthead bg-primary  text-white text-center" style="height: 700px; margin-top: -90px;">
    <div class="container">
      <div class="col-md-4 offset-sm-4">
        ...
        <div class="card-header text-dark">Lecturer Login</div>
        <div class="card-body">
      ...
      <h3 class="font-weight-light mb-3 animated bounceInDown"> Lecturer Login Page!</h3>
