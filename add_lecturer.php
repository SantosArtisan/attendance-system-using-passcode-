...
$query=mysqli_query($connection,"SELECT * FROM lecturer WHERE email='$email'");
...
$sql= mysqli_query($connection,"INSERT INTO lecturer (title,fname,sname,oname,gender,rank,phone,email,username,password,pics) VALUES('$title','$fname','$sname','$oname','$gender','$rank','$phone','$email','$username','$password','$location')");  

 
echo "<script> alert ('Lecturer Added Sucessfully!!!'); window.location='add_lecturer.php'</script>";
  ...
  <header class="masthead bg-primary h-100" style=" margin-top: -120px;">
    <div class="container-fluid">
      ...
      <div class="col-md-9">
        ...
        <div class="card mt-3">
          <div class="card-header"><i class="fa fa-user"> </i> Add Lecturer</div>
          <div class="card-body">
